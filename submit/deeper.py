...
from .extra_modules import get_aspp, get_trunk, ConvBnRelu, mask_attn_head
from .utils import scale_as, fmt_scale
...
def DeeperX71(num_classes, criterion=None):
    ...
    return DeeperS8(num_classes, criterion=criterion, trunk="xception71", dpc=False)
