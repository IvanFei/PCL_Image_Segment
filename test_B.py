...
from utils.utils import get_logger, cfg_parser, save_args, prepare_dirs, write_mask, write_pred
...
def get_args():
    ...
    parser.add_argument("--mode", type=str, default="test_B")
...
def test(args, dataloader, model, cuda=False):
    ...
    with torch.no_grad():
        for idx, data_batch in enumerate(dataloader):
            ...
            write_pred(args, probs, preds, img_names, save_dir=args.save_dir)
